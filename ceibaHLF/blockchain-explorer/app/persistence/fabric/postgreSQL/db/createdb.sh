...
#sudo -u postgres psql -v dbname=$DATABASE_DATABASE -v user=$DATABASE_USERNAME -v passwd=$DATABASE_PASSWD -f ./explorerpg.sql ;
#sudo -u postgres psql -v dbname=$DATABASE_DATABASE -v user=$DATABASE_USERNAME -v passwd=$DATABASE_PASSWD -f ./updatepg.sql ;;
esac
